                ...
                <div class="card">
                    <div class="card-body p-0">
                        <div class="media p-3">
                            ...
                            <div class="align-self-center" style="position: relative;" data-toggle="tooltip" data-placement="top" title="Inmuebles Alquilados" >
                                ...
                                <span class="text-success font-weight-bold font-size-13"><i class="uil uil-arrow-up"></i> {{ alquilados_i_p() }}%</span>
                            <div class="resize-triggers"><div class="expand-trigger"><div style="width: 91px; height: 67px;"></div></div><div class="contract-trigger"></div></div>
                            </div>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body p-0">
                        <div class="media p-3">
                            <div class="media-body">
                                <span class="text-muted text-uppercase font-size-12 font-weight-bold">Estacionamientos</span>
                            ...
                            <div class="align-self-center" style="position: relative;" data-toggle="tooltip" data-placement="top" title="Estacionamientos Alquilados" >
                                ...
                                <span class="text-danger font-weight-bold font-size-13"><i class="uil uil-arrow-down"></i> {{ alquilados_e_p() }}%</span>
                    ...
                    <div class="card-body p-0">
                        <div class="media p-3">
                            <div class="media-body">
                                ...
                                <h6 class="mb-0">C/Inmuebles: {{ residentes_alquilados_i() }}</h6>
                                <h6 class="mb-0">C/Estacionamiento: {{ residentes_alquilados_e() }}</h6>
                                <h6 class="mb-0"><a href="#" style="width: 100% !important; position: relative;" data-toggle="modal" data-target="#crearResidente" class="btn btn-success">Nuevo</a></h6>
                            </div>
                            <div class="align-self-center" style="position: relative;" data-toggle="tooltip" data-placement="top" title="Residentes con Alquileres" >
                                ...
                                <span class="text-success font-weight-bold font-size-13"><i class="uil uil-arrow-up"></i> {{ residentes_alquilados_p() }}%</span>
                            <div class="resize-triggers"><div class="expand-trigger"><div style="width: 91px; height: 67px;"></div></div><div class="contract-trigger"></div></div></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-0">
                        <div class="media p-3">
                            <div class="media-body">
                                ...
                                <hr>
                                <h6 class="mb-0"><a href="#" style="width: 100% !important;" onclick="PagoC(1)" class="btn btn-primary">Inmuebles</a></h6>
                                <h6 class="mb-0"><a href="#" style="width: 100% !important;" onclick="PagoC(2)" class="btn btn-danger">Estacionamientos</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
