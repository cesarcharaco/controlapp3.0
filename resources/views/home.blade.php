                    ...
                    <div class="card-body p-0">
                        <div class="media p-3">
                            <div class="media-body">
                                ...
                                <h5 class="mb-0">Existencia: {{ existencia_i() }}</h5>
                                <h5 class="mb-0">Alquilados: {{ alquilados_i_t() }}</h5><br>
                            </div>
                    ...
                    <div class="card-body p-0">
                        <div class="media p-3">
                            <div class="media-body">
                                ...
                                <h5 class="mb-0">Existencia: {{ existencia_e() }}</h5>
                                <h5 class="mb-0">Alquilados: {{ alquilados_e_t() }}</h5>
                            </div>
                    ...
                    <div class="card-body p-0">
                        <div class="media p-3">
                            <div class="media-body">
                                ...
                                <h5 class="mb-0">Registrados: {{ residentes() }}</h5>
                                <h5 class="mb-0">C/Inmuebles: {{ residentes_alquilados_i() }}</h5>
                                <h5 class="mb-0">C/Estacionamiento: {{ residentes_alquilados_e() }}</h5>
                            </div>
